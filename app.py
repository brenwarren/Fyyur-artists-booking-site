...
#----------------------------------------------------------------------------#
# Models. ***SEE models.py FOR MODEL DEFINITIONS.***
#----------------------------------------------------------------------------#
...
# def search_venues():
  ...
  # >>>> Done - see search_venues function below.
...
def shows():
  ...
  # Replace with real venue data from database
  data = []
...
def create_show_submission():
  ...
  # >>>> Done - see create_show_submission function below.
